                                ...
                                <tbody>
                                    @foreach ($coursedetails as $coursedetail)
                                        <tr>
                                            ...
                                            @if ($coursedetail->language)
                                                <td>{{ $coursedetail->language->name }}</td>
                                            @else
                                                <td>No language</td>
                                            @endif

                                            @if ($coursedetail->course)
                                                <td>{{ $coursedetail->course->title }}</td>
                                            @else
                                                <td>No course</td>
                                            @endif
                                        ...
                                        @endif
                                            ...
                                            <td>{!! html_entity_decode($coursedetail->course_description) !!}</td>
                                            <td>{!! html_entity_decode($coursedetail->what_you_will_learn) !!}</td>
                                            <td>{!! html_entity_decode($coursedetail->certification_description) !!}</td>
