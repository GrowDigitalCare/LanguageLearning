                    ...
                    <div class="col-md-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    {{ dd($tests) }}
                                    <form class="form form-vertical" action="{{ route('competitionquestion-update', $question->id) }}" method="POST" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                        ...
                                                        <fieldset class="form-group">
                                                            <select class="form-select" id="subjectSelect" name="test_id">
                                                                @foreach($tests as $testItem)
                                                                    <option data-mcq="{{ $testItem->total_mcq }}" value="{{ $testItem->id }}" {{ $question->test_id == $testItem->id ? 'selected' : '' }}>
                                                                        {{ optional($testItem->competitionsubject)->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </fieldset>
                                        ...
                                        <div class="col-12 d-flex justify-content-end">
                                            ...
                                            <a href="{{ route('competitionquestion-list') }}" class="btn btn-light-secondary me-1 mb-1">
                                                Cancel
                                            </a>
                                        </div>
                                    </form>
