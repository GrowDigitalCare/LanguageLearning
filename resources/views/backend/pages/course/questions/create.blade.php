...
@section('content')
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" action="{{ route('coursequiz-store') }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="title">Select Test</label>
    ...
    <script>
        ...
        <div class="form-group">
            <label for="audio${questionNumber}">Question ${questionNumber}</label>
            <input type="file" class="form-control" name="questions[${questionNumber}][audio]"
