          ...
          <div class="col-12 col-md-6 order-md-2 order-first">
              <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Course  Table</li>
                  </ol>
              </nav>
          </div>
      </div>
      ...
      <div class="card">
          ...
          <div class="">
              <a href="{{ route('course-create') }}" class="btn btn-success"
                  style="float: right; margin-top: -51px; margin-right: 41px;">Add Course </a>
                        ...
                        @foreach($course as $course)
                              <tr>
                                <td>{{ $course->language->name }}</td>
                                  ...
                                  <td><img style="height:50px; width:50px;" src="{{asset('/uploads/course/'.$course->image)}}" alt=""></td>
