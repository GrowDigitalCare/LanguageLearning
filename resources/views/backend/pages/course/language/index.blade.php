          ...
          <div class="col-12 col-md-6 order-md-2 order-first">
              <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Course Language Table</li>
                  </ol>
              </nav>
          </div>
      </div>
      ...
      <div class="card">
          ...
          <div class="">
              <a href="{{ route('language-create') }}" class="btn btn-success"
                  style="float: right; margin-top: -51px; margin-right: 41px;">Add Course Langauge</a>
                      ...
                      <tbody>
                        @foreach($language as $language)
                              <tr>
                                  ...
                                  <td><img style="height:50px; width:50px;" src="{{asset('/uploads/language/'.$language->image)}}" alt=""></td>
                                  ...
                                  <td>
                                      <div style="display: flex; align-items: center;">
                                          ...
                                          <a href="{{ route('language-edit', ['id' => $language->id]) }}"><i
