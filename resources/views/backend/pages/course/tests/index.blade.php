          ...
          <div class="col-12 col-md-6 order-md-2 order-first">
              <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Tests Table</li>
                  </ol>
              </nav>
          </div>
      </div>
      ...
      <div class="card">
          ...
          <div class="">
              <a href="{{ route('test-create') }}" class="btn btn-success"
                  style="float: right; margin-top: -51px; margin-right: 41px;">Add Test</a>
                      ...
                      <tbody>
                        @foreach($tests as $test)
                              <tr>
                                  ...
                                  <td>{!! html_entity_decode($test->description) !!}</td>
                                 ...
                                 <td>{{ $test->level }}</td>
                                  <td>
                                      <div style="display: flex; align-items: center;">
                                          <a href="{{ route('test-delete', ['id' => $test->id]) }}"
