...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('admin') }}/assets/images/logo/favicon.jpeg" type="image/png">
</head>
    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href=""><img src="{{asset('admin')}}/assets/images/logo/logo-white.png" style="width: 75%;height: 40%;"  alt="Logo"></a>
                    </div>
