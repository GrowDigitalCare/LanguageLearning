                              ...
                              <tr>
                                  ...
                                  <td>
                                    @if($users->profile_image)
                                        <img style="height: 50px; width: 50px;" src="{{ asset('uploads/Students/'.$users->profile_image) }}" alt="">
                                    @else
                                        <img style="height: 50px; width: 50px;" src="{{asset('admin')}}/assets/images/faces/2.jpg" alt="Default Avatar">
