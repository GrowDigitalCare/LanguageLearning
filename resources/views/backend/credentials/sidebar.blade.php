    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="{{route('admin-dashboard')}}"><img src="{{asset('admin')}}/assets/images/logo/logo.jpeg" alt="Logo" srcset="" style="width: 100%;height: 35px;" >
                    </a>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  ">
                    <a href="{{ route('admin-useres') }}" class='sidebar-link'>
                        <i class="bi bi-bookmark-plus-fill"></i>
                        <span>All Useres List</span>
                    </a>
                </li>
                <li class="sidebar-item  ">
                ...
                <li class="sidebar-item {{ Route::is('course*') ? 'active' : '' }} has-sub">
                    ...
                    <ul class="submenu {{ Route::is('course*') ? 'active' : '' }}">
                        ...
                        <li class="submenu-item {{ Route::is('language-list') ? 'active' : '' }}">
                            <a href="{{ route('language-list') }}">Language</a>
                        </li>
                        <li class="submenu-item {{ Route::is('course-list') ? 'active' : '' }}">
                            <a href="{{ route('course-list') }}">Course</a>
                        </li>
                        <li class="submenu-item {{ Route::is('coursedetail-list') ? 'active' : '' }}">
                            <a href="{{ route('coursedetail-list') }}">Course Detail</a>
                        </li>
                        ...
                        <li class="submenu-item {{ Route::is('test-list') ? 'active' : '' }}">
                            <a href="{{ route('test-list') }}">Lectures Test</a>
                        </li>

                        <li class="submenu-item {{ Route::is('coursequiz-list') ? 'active' : '' }}">
                            <a href="{{ route('coursequiz-list') }}">Questions</a>
                        </li>
                ...
                {{-- <li class="sidebar-item {{ Route::is('status*') ? 'active' : '' }} has-sub">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-bookmark-plus-fill"></i>
                        <span>Status</span>
                    </a>
                    <ul class="submenu {{ Route::is('status*') ? 'active' : '' }}">
                        <li class="submenu-item {{ Route::is('status-create') ? 'active' : '' }}">
                            <a href="{{route('status-create')}}">create</a>
                        </li>
                        <li class="submenu-item {{ Route::is('status-list') ? 'active' : '' }}">
                            <a href="{{route('status-list')}}">list</a>
                        </li>
                    </ul>
                </li> --}}
