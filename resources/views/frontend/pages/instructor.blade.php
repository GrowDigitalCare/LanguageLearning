...
@section('title')
    ...
    <head>
        <title>About Us | BrainBattleAcademy</title>
        <meta name="description" content="About Us Page" />
        <meta name="keywords" content="BrainBattleAcademy" />
        <meta name="title" content="About Us" />
        <meta property="og:image" content="http://brainbattleacademy.com/assets/images/logo/logo.png" />
        <meta property="og:url"
            content="http://brainbattleacademy.com/aboutus" />
        <meta property="og:type" content="website" />
          <meta property="og:title" content="About Us Page" />
        <meta property="og:description" content="About Us Page" />
        <meta property="og:keywords" content="About Us Page" />
    </head>
@endsection
@section('content')
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                        <div class="instructor__sidebar" data-tilt>
                            <div class="instructor__sidebar__img" data-aos="fade-up">
                                <img loading="lazy"  src="img/team/team__4.png" alt="team">
                                <div class="instructor__sidebar__small__img">
                                    <img loading="lazy"  src="img/about/about_4.png" alt="img">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="instructor__inner__wraper">
                            ...
                            <div class="instructor__content__wraper" data-aos="fade-up">
                                <h6>Short Bio</h6>
                                <p>Only a quid me old mucker squiffy tomfoolery grub cheers ruddy cor blimey guvnor in my flat, up the duff Eaton car boot up the kyver pardon you A bit of how's your father David skive off sloshed, don't get shirty with me
                                    chip shop vagabond crikey bugger Queen's English chap. Matie boy nancy boy bite your arm off up the kyver old no biggie fantastic boot, David have it show off show off pick your nose and blow off lost the plot porkies
                                    bits and bobs only a quid bugger all mate, absolutely bladdered bamboozled it's your round don't get shirty with me down the pub well.</p>
                            </div>
