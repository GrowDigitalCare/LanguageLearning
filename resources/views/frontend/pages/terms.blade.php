...
@section('content')
	...
	<div class="banner-style-2" style="background-image:url(assets/images/about_banner.jpg);">
	  <div class="container">
		<div class="row">
    ...
    <p>Welcome to Grow Digital Care!</p>

    <p>These terms and conditions outline the rules and regulations for the use of Grow Digital Care's Website, located at
        www.growdigitalcare.com.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Grow Digital Care
    ...
    <p>We employ the use of cookies. By accessing Grow Digital Care, you agreed to use cookies in agreement with the Grow
        Digital Care's Privacy Policy. </p>
    ...
    <p>Unless otherwise stated, Grow Digital Care and/or its licensors own the intellectual property rights for all material
        on Grow Digital Care. All intellectual property rights are reserved. You may access this from Grow Digital Care for
        your own personal use subjected to restrictions set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
        <li>Republish material from Grow Digital Care</li>
        <li>Sell, rent or sub-license material from Grow Digital Care</li>
        <li>Reproduce, duplicate or copy material from Grow Digital Care</li>
        <li>Redistribute content from Grow Digital Care</li>
    </ul>

    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas
        of the website. Grow Digital Care does not filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of Grow Digital Care,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, Grow Digital Care shall not be liable for the Comments or for any liability, damages or expenses
        caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
        website.</p>

    <p>Grow Digital Care reserves the right to monitor all Comments and to remove any Comments which can be considered
    ...
    <p>You hereby grant Grow Digital Care a non-exclusive license to use, reproduce, edit and authorize others to use,
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Grow Digital Care;
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to Grow Digital Care. Please include your name, your organization name, contact
    ...
    <p>No use of Grow Digital Care's logo or other artwork will be allowed for linking absent a trademark license agreement.
    </p>
