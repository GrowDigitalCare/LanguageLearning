...
@section('title')
    ...
    <head>
        <title>Home | Grow Digital Care</title>
        ...
        <div class="row">
            ...
            <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                ...
                <div class="herobanner__video registerarea__video">
                    <img loading="lazy"  src="{{asset('assets')}}/img/herobanner/herobanner__video.jpg" alt="Video Banner">
            ...
            <div class="single__service">
                <div class="service__img">
                    ...
                    <div class="service__bg__img">
                        {{-- <svg class="service__icon__bg" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            {{-- <img src="{{ asset('/uploads/language/' . $language->image) }}" class="service__icon__bg" alt=""> --}}
                    </div>
                </div>
                ...
                <div class="service__small__img">
                    <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M16.5961 10.265L19 1.33069L10.0022 3.73285L1 6.1306L7.59393 12.6627L14.1879 19.1992L16.5961 10.265Z" stroke="#FFB31F" stroke-width="6" stroke-linecap="square" stroke-linejoin="round"/>
                        </svg>
                </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                <div class="about__right__wraper__2 about__right__wraper__4">
                    <div class="educationarea__img" data-tilt>
                        <img loading="lazy"  class="aboutimg__4__img__1" src="{{asset('assets')}}/img/about/about_13.png" alt="about">
                        <img loading="lazy"  class="aboutimg__4__img__2" src="{{asset('assets')}}/img/about/about_12.png" alt="about">
                    </div>
    ...
    <div class="container">
        ...
        <div class="row grid" data-aos="fade-up">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter4 filter5">
                <div class="gridarea__wraper">
                    <div class="gridarea__img">
                        <a href="course-details.html"><img loading="lazy"  src="{{asset('assets')}}/img/grid/grid_3.png" alt="grid"></a>
                        <div class="gridarea__small__button">
                    ...
                    <div class="gridarea__content">
                        ...
                        <div class="gridarea__bottom">
                            ...
                            <a href="instructor-details.html">
                                <div class="gridarea__small__img">
                                    <img loading="lazy"  src="{{asset('assets')}}/img/grid/grid_small_3.jpg" alt="grid">
                                    <div class="gridarea__small__content">
                                        <h6>Micle Jhon</h6>
                                    </div>
                                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter4">
                <div class="gridarea__wraper">
                    <div class="gridarea__img">
                        <a href="course-details.html"><img loading="lazy"  src="{{asset('assets')}}/img/grid/grid_4.png" alt="grid"></a>
                        <div class="gridarea__small__button">
                    ...
                    <div class="gridarea__content">
                        ...
                        <div class="gridarea__bottom">
                            ...
                            <a href="instructor-details.html">
                                <div class="gridarea__small__img">
                                    <img loading="lazy"  src="{{asset('assets')}}/img/grid/grid_small_4.jpg" alt="grid">
                                    <div class="gridarea__small__content">
                                        <h6>Micle Robin</h6>
                                    </div>
                                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter1 filter3">
                <div class="gridarea__wraper">
                    <div class="gridarea__img">
                        <a href="course-details.html"><img loading="lazy"  src="{{asset('assets')}}/img/grid/grid_5.png" alt="grid"></a>
                        <div class="gridarea__small__button">
                    ...
                    <div class="gridarea__content">
                        ...
                        <div class="gridarea__bottom">
                            ...
                            <a href="instructor-details.html">
                                <div class="gridarea__small__img">
                                    <img loading="lazy"  src="{{asset('assets')}}/img/grid/grid_small_5.jpg" alt="grid">
                                    <div class="gridarea__small__content">
                                        <h6>Micle Robin</h6>
                                    </div>
                                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter5 filter2">
                <div class="gridarea__wraper">
                    <div class="gridarea__img">
                        <a href="course-details.html"><img loading="lazy"  src="{{asset('assets')}}/img/grid/grid_6.png" alt="grid"></a>
                        <div class="gridarea__small__button">
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                <div class="testimonial__group__img" data-tilt>
                    <img loading="lazy"  src="{{asset('assets')}}/img/testimonial/testi__group__1.png" alt="">
                </div>
            </div>
        </div>
    </div>
