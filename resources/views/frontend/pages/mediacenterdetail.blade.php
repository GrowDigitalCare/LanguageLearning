            ...
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="blog__details__content__wraper">
                    <div class="blog__details__img" data-aos="fade-up">
                        <img loading="lazy"  src="{{asset('assets')}}/img/blog/blog_21.png" alt="blog">
                    </div>
                    <div class="blog__details__content">
                        ...
                        <div class="blockquate__wraper" data-aos="fade-up">
                            ...
                            <div class="blockquate__img">
                                <img loading="lazy"  src="{{asset('assets')}}/img/blog/blog_22.png" alt="img">
                            </div>
                        ...
                        <div class="row blog__details__margin">
                            <div class="col-xl-4 col-lg-4 col-md-4" data-aos="fade-up">
                                <div class="blog__details__img__2">
                                    <img loading="lazy"  src="{{asset('assets')}}/img/blog/blog_23.png" alt="blog">
                    ...
                    <ul class="recent__list">
                        <li>
                            <div class="recent__img">
                                <a href="#">
                                    <img loading="lazy"  src="{{asset('assets')}}/img/blog/blog_11.png" alt="sidbar">
                        ...
                        <li>
                            <div class="recent__img">
                                <a href="#">
                                    <img loading="lazy"  src="{{asset('assets')}}/img/blog/blog_12.png" alt="sidbar">
                                    <div class="recent__number">
                                        <span>02</span>
                                    </div>
                                </a>
                        ...
                        <li>
                            <div class="recent__img">
                                <a href="#">
                                    <img loading="lazy"  src="{{asset('assets')}}/img/blog/blog_13.png" alt="sidbar">
                                    <div class="recent__number">
                                        <span>03</span>
                                    </div>
                                </a>
                        ...
                        <li>
                            <div class="recent__img">
                                <a href="#">
                                    <img loading="lazy"  src="{{asset('assets')}}/img/blog/blog_14.png" alt="sidbar">
                                    <div class="recent__number">
                                        <span>04</span>
                                    </div>
                                </a>
                    ...
                    <div class="photo__gallery__img">
                        ...
                        <div class="single__gallery__img">
                            ...
                            <div class="gallery__icon">
                                <a class="popup__img" href="{{asset('assets')}}/img/blog/blog_15.png"> <i class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
                        <div class="single__gallery__img">
                            <img loading="lazy"  src="{{asset('assets')}}/img/blog/blog_16.png" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="{{asset('assets')}}/img/blog/blog_16.png"> <i class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
                        <div class="single__gallery__img">
                            <img loading="lazy"  src="{{asset('assets')}}/img/blog/blog_17.png" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="{{asset('assets')}}/img/blog/blog_17.png"> <i class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
                        <div class="single__gallery__img">
                            <img loading="lazy"  src="{{asset('assets')}}/img/blog/blog_18.png" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="{{asset('assets')}}/img/blog/blog_18.png"> <i class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
                        <div class="single__gallery__img">
                            <img loading="lazy"  src="{{asset('assets')}}/img/blog/blog_19.png" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="{{asset('assets')}}/img/blog/blog_19.png"> <i class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
                        <div class="single__gallery__img">
                            <img loading="lazy"  src="{{asset('assets')}}/img/blog/blog_20.png" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="{{asset('assets')}}/img/blog/blog_20.png"> <i class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
