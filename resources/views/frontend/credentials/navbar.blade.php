          ...
          {{-- <div class="row headerarea__search__wrap align-items-center">
              <div class="col-xl-3 col-lg-3">
                  ...
                  <div class="headerarea__2__info__img">
                      <a href="#"><img loading="lazy"  src="{{asset('assets')}}/{{asset('assets')}}/img/icon/flag1.webp" alt="img">
                          ENG
                      ...
                      <ul class="language__dropdown">
                          <li><a href="#"><img loading="lazy"  src="{{asset('assets')}}/img/icon/flag2.webp" class="img-fluid" alt="">
                                  FR</a></li>
                          <li><a href="#"><img loading="lazy"  src="{{asset('assets')}}/img/icon/flag3.webp" class="img-fluid" alt="">
                                  DE</a></li>
                      </ul>
                  </div>
                  ...
                  <div class="headerarea__2__info__img">
                      ...
                      <ul class="language__dropdown">
                          <li><a href="#"><img loading="lazy"  src="{{asset('assets')}}/img/logo/logo__4.html" class="img-fluid" alt="">
                                  FR</a></li>
                          <li><a href="#"><img loading="lazy"  src="{{asset('assets')}}/img/logo/logo__5.html" class="img-fluid" alt="">
                                  DE</a></li>
                      </ul>
                  </div>
              ...
              <div class="col-xl-2 col-lg-2 col-md-6">
                  <div class="headerarea__left">
                      <div class="headerarea__left__logo">
                          ...
                          <a href="index.html"><img loading="lazy"  src="{{asset('assets')}}/img/logo/logo_1.png" alt="logo"></a>
                      </div>
                      ...
                      <nav>
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="index.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-1.png" alt="Mega Menu">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-2.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-2.png" alt="Mega Menu">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-3.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-3.png" alt="Mega Menu">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-4.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-4.png" alt="Mega Menu">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-5.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-5.png" alt="Mega Menu">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-6.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-6.png" alt="Mega Menu">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-7.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-7.png" alt="Mega Menu">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-8.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-8.png" alt="Mega Menu">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-9.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-9.png" alt="Mega Menu">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-10.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-10.png" alt="Mega Menu">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-11.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-11.png" alt="Mega Menu">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="#">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/coming.png" alt="Mega Menu 1">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="#">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/coming.png" alt="Mega Menu 2">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="#">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/coming.png" alt="Mega Menu 3">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="#">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/coming.png" alt="Mega Menu 4">
                                          ...
                                          <div class="tab-pane fade" id="projects__dark" role="tabpanel" aria-labelledby="projects__dark">
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="index-dark.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-1-dark.png" alt="Mega Menu">
                                                              <span class="mega__menu__thumb__title">Home (Default)</span>
                                                          </a>
                                                      </div>                                            
                                                  </div>
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-2-dark.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-2-dark.png" alt="Mega Menu">
                                                              <span class="mega__menu__thumb__title">Home (Elegant)</span>
                                                          </a>
                                                      </div>                                            
                                                  </div>
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-3-dark.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-3-dark.png" alt="Mega Menu">
                                                              <span class="mega__menu__thumb__title">Home (Classic)</span>
                                                          </a>
                                                      </div>                                            
                                                  </div>
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-4-dark.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-4-dark.png" alt="Mega Menu">
                                                              <span class="mega__menu__thumb__title">Home (Classic LMS)</span>
                                                          </a>
                                                      </div>                                            
                                                  </div>
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-5-dark.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-5-dark.png" alt="Mega Menu">
                                                              <span class="mega__menu__thumb__title">Home (Online Course)</span>
                                                          </a>
                                                      </div>                                            
                                                  </div>
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-6-dark.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-6-dark.png" alt="Mega Menu">
                                                              <span class="mega__menu__thumb__title">Home (Marketplace)</span>
                                                          </a>
                                                          <span class="mega__menu__thumb__label">New</span>
                                                      </div>                                            
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-7-dark.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-7-dark.png" alt="Mega Menu">
                                                              <span class="mega__menu__thumb__title">Home (University)</span>
                                                          </a>
                                                          <span class="mega__menu__thumb__label">New</span>
                                                      </div>                                            
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-8-dark.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-8-dark.png" alt="Mega Menu">
                                                              <span class="mega__menu__thumb__title">Home (eCommerce)</span>
                                                          </a>
                                                          <span class="mega__menu__thumb__label">New</span>
                                                      </div>                                            
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-9-dark.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-9-dark.png" alt="Mega Menu">
                                                              <span class="mega__menu__thumb__title">Home (Kindergarten)</span>
                                                          </a>
                                                          <span class="mega__menu__thumb__label">New</span>
                                                      </div>                                            
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-10-dark.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-10-dark.png" alt="Mega Menu">
                                                              <span class="mega__menu__thumb__title">Home (Machine Learning)</span>
                                                          </a>
                                                          <span class="mega__menu__thumb__label">New</span>
                                                      </div>                                            
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="home-11-dark.html">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/home-11-dark.png" alt="Mega Menu">
                                                              <span class="mega__menu__thumb__title">Home (Single Course)</span>
                                                          </a>
                                                          <span class="mega__menu__thumb__label">New</span>
                                                      </div>                                            
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="#">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/coming-dark.png" alt="Mega Menu 1">
                                                              <span class="mega__menu__thumb__title">Layout Coming Soon 1</span>
                                                          </a>
                                                      </div>                                            
                                                  </div>
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="#">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/coming-dark.png" alt="Mega Menu 2">
                                                              <span class="mega__menu__thumb__title">Layout Coming Soon 2</span>
                                                          </a>
                                                      </div>                                            
                                                  </div>
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="#">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/coming-dark.png" alt="Mega Menu 3">
                                                              <span class="mega__menu__thumb__title">Layout Coming Soon 3</span>
                                                          </a>
                                                      </div>                                            
                                                  </div>
                                                  ...
                                                  <div class="col-3 mega__menu__single__wrap">                                            
                                                      <div class="mega__menu__thumb">
                                                          <a href="#">
                                                              <img loading="lazy"  src="{{asset('assets')}}/img/mega/coming-dark.png" alt="Mega Menu 4">
                                                              <span class="mega__menu__thumb__title">Layout Coming Soon 4</span>
                                                          </a>
                                                      </div>                                            
                                                  </div>
                          ...
                          <li><a class="headerarea__has__dropdown" href="dashboard/instructor-dashboard.html">Dashboard
                              ...
                              <ul class="headerarea__submenu headerarea__submenu--third--wrap">
                                  <li><a href="https://html.themewin.com/edurock-preview/admin-dashboard.html">Admin <i class="icofont-rounded-right"></i></a>
                  ...
                  <div class="headerarea__right">
                      ...
                      <!-- <div class="header__cart">
                          ...
                          <div class="header__right__dropdown__wrapper">
                              ...
                              <div class="header__right__dropdown__button">
                                  <a href="ecommerce/cart.html" class="white__color">View Cart</a>
                      ...
                      <div class="headerarea__button">
                        <a href="#"><i class="icofont-user-alt-5"></i> {{ Auth::user()->name }}</a>
                    </div>
                    &nbsp;
                    <div class="headerarea__button">
                        @if(Auth::user()->role == 'Student')
                        <a href="{{ route('admin-dashboard') }}"><i class="icofont-user-alt-5"></i> Dashboard</a>
                    ...
                    @else
                      <div class="headerarea__button">
                          <a href="#"><i class="icofont-user-alt-5"></i> Login</a>
                      </div>
                      &nbsp;
                      <div class="headerarea__button">
                        <a href="#"><i class="icofont-user-alt-5"></i> Register</a>
                    </div>
                    @endauth
                  </div>
              </div>
