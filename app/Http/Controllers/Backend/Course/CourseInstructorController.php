...
class CourseInstructorController extends Controller
{
    ...
    public function view(){
        return view('backend.pages.course.instructor.create');
    }

    public function show(){
        $Instructor=Instructor::all();
        return view('backend.pages.course.instructor.list',compact('Instructor'));
    }
    ...
    public function edit($id){
        ...
        return view('backend.pages.course.instructor.edit',compact('Instructor'));
